 ...
 */
@Entity
@Table(name = "t_municipality_form_statistics", schema = "public", catalog = "edu_forms_test")
public class TMunicipalityFormStatistics {
    private long rowId;
    private int munitId;
    ...
    public boolean equals(Object o) {
        ...
        TMunicipalityFormStatistics that = (TMunicipalityFormStatistics) o;
