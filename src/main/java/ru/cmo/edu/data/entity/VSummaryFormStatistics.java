 ...
 */
@Entity
@Table(name = "summary_form_statistics", schema = "public", catalog = "edu_forms_test")
public class VSummaryFormStatistics {
    private Long rowId;
    ...
    public boolean equals(Object o) {
        ...
        VSummaryFormStatistics that = (VSummaryFormStatistics) o;
