...
public class EduFormDataEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        EduFormDataEntity that = (EduFormDataEntity) o;
    ...
    public void setForm(FormEntity formByFormId) {
        this.form = formByFormId;
    }

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "edu_id", referencedColumnName = "edu_id", nullable = false)
    public EduEntity getEdu() {
        return edu;
    }

    public void setEdu(EduEntity eduByEduId) {
        this.edu = eduByEduId;
    }
    ...
    public void setFile(FileEntity fileByFileId) {
        this.file = fileByFileId;
    }
}
